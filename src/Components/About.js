  ...
  render() {
    return (
      <div className="aboutParent">
        <div className='Team aboutContainer'>
          <img src={require('../Media/Images/Staff/CMP-Team-OPTIMIZED.jpg')} alt={'Team'} className={'staffpic'}/>
        </div>
        <p class="aboutUs">
        ...
        <div className="aboutContainer">
          <div className='person1'><img src={require('../Media/Images/Staff/1.jpg')} alt={'Jonas'}
                                        className={'Jonas'}></img><p>Jonas Waddell - President & CEO</p></div>
          <div className='person2'><img src={require('../Media/Images/Staff/Jeanine Waddell VICE PRESIDENT.JPG')}
                                        alt={'Jeanine'} className={'Jeanine'}></img><p>Jeanine Waddell - Vice
            President</p></div>
